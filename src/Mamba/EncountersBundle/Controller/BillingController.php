...
class DefaultController extends Controller {
    ...
    public function indexAction() {
        ...
        exit(var_dump($this->get('mamba')->Geo()->getCountries()));
        exit(print_r($this->get('mamba')->Search()->get(
            'M', 'F', 18, 18/*, 'love', false, false, false, false, null, null, null, null, 20, array(), true*/
        )));
        //exit(var_dump($this->get('mamba')->Contacts()->getFolderList()));
        //exit(var_dump($this->get('mamba')->Contacts()->getContactList()));
        exit(var_dump($this->get('mamba')->Anketa()->getInfo(array(724727671))));
    }
